          ...
          <div className="chatbot-messages" style={styles.messages}>
            ...
            {loading && (
              <div style={styles.msgRow("assistant")}>
                <div style={styles.botAvatar}>🌾</div>
                <div
                  style={{ ...styles.bubble("assistant"), ...styles.typing }}
                >
...
const styles = {
  ...
  window: {
    ...
    boxShadow:
      "0 24px 64px rgba(0,0,0,0.7), inset 0 1px 0 rgba(255,255,255,0.08)",
    display: "flex",
  ...
  avatar: {
    ...
    borderRadius: "50%",
    background:
      "linear-gradient(135deg, rgba(6,95,70,0.8), rgba(16,185,129,0.6))",
    border: "1px solid rgba(16,185,129,0.4)",
    display: "flex",
    alignItems: "center",
    justifyContent: "center",
