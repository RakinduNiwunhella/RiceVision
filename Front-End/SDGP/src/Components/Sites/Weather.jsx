...
export default function RiceVisionWeather() {
  ...
  const tutorialSteps = [
    {
      title: "View current weather conditions and atmospheric data",
      ref: weatherHeaderRef
    },
    {
      title: "Click to view 24-hour weather progression",
      ref: hourlyTabRef
    },
    {
      title: "Click to view soil conditions and agronomic data",
      ref: soilTabRef
    },
    {
      title: "Click to see extended 14-day weather outlook",
      ref: forecastTabRef
    },
    {
      title: "Click to view past historical weather patterns",
      ref: historyTabRef
    }
  ];
