...
const Help = () => {
  ...
  return (
    <div className="min-h-full py-10 text-white font-sans">
      <div className="max-w-7xl mx-auto px-6 space-y-10 pb-20">
        {/* Header Section */}
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
          <div>
            <h1
              className="flex items-center gap-2 sm:gap-3 text-xl sm:text-3xl md:text-5xl font-black text-white tracking-tight"
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-6 lg:gap-10 items-stretch">
          {[
            ...
            },
            {
              ...
              action: `${t("email")}: ${SUPPORT_EMAIL}`,
              href: `mailto:${SUPPORT_EMAIL}?subject=RiceVision%20Support%20Request`,
              color: "cyan",
            },
          ].map((card, idx) => (
            <div
            ...
            <div className="glass p-6 md:p-8 lg:p-10 rounded-xl sm:rounded-2xl md:rounded-[2.5rem] border border-white/10 shadow-2xl h-full flex flex-col space-y-6 sm:space-y-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-4">
                  <div>
                    <label className="block text-[10px] font-black uppercase tracking-widest text-white/85 mb-2 ml-1">
                      {t("fullOperatorName")}
                    </label>
                    <input
                      name="full_name"
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={handleChange}
                      className={inputClass}
                      placeholder={t("assignedPositionExample")}
                    />
                  </div>
                </div>
            ...
            <div className="glass p-6 md:p-8 lg:p-10 rounded-xl sm:rounded-2xl md:rounded-[2.5rem] border border-white/10 shadow-xl h-full flex flex-col">
                ...
                onClick={() => {
                  ...
                  setTimeout(() => {
                    window.dispatchEvent(
                      new CustomEvent("replay-onboarding-tour"),
                    );
                  }, 500);
                }}
              ...
              {faqLoading && (
                <div className="flex items-center gap-3 py-10 justify-center">
                  ...
                  <span className="text-xs font-black uppercase text-white/85">
                    {t("decryptingFaqs")}
                  </span>
                </div>
              )}
            ...
            <div className="flex flex-wrap gap-4 flex-1">
              {[
                ...
                <button
                  ...
                  className="flex items-center justify-center gap-2 px-6 py-3 rounded-xl bg-white/5 hover:bg-white/10 border border-white/10 hover:border-white/20 transition-all group flex-1 sm:flex-none cursor-pointer"
                >
