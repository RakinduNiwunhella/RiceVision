        ...
        <div className="absolute inset-0 flex items-center justify-center md:justify-end pointer-events-none">
          <div className="w-full max-w-2xl px-4 md:px-0 md:max-w-lg lg:max-w-xl md:mr-6 lg:mr-20 transform translate-y-4 pointer-events-auto">
            <div className="bg-white dark:bg-slate-800 rounded-xl shadow-2xl p-8 md:p-12">
              <h1 className="text-3xl md:text-4xl font-extrabold leading-tight text-center dark:text-white">Satellite-Based Rice <br className="hidden md:block" />Monitoring & Yield Forecasting</h1>
              <p className="mt-4 text-center text-slate-600 dark:text-white">Combining remote sensing and machine learning to monitor crop health and predict rice yields across Sri Lanka.</p>
